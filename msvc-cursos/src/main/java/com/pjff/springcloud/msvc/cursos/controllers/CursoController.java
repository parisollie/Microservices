package com.pjff.springcloud.msvc.cursos.controllers;
...
import com.pjff.springcloud.msvc.cursos.services.CursoService;
...
public class CursoController {
    ...
    // Vid 23,paso 5, se parece al anterior que creamos.
    @Autowired
    ...
    public ResponseEntity<?> detalle(@PathVariable Long id) {
        // Vid 40 ,add service.porIdConUsuarios(id);//service.porId(id);
    ...
    @PostMapping("/")
    // Vid 28, ponemos las validaciones
    ...
    public ResponseEntity<?> asignarUsuario(@RequestBody Usuario usuario, @PathVariable Long cursoId) {
        ...
        // Vid 37, pasamos el objeto usuario: o.get()
        if (o.isPresent()) {
